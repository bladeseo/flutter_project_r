...
mixin _$MenuStoreRest on _MenuStoreRest, Store {
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??=
          Computed<bool>(() => super.loading, name: '_MenuStoreRest.loading'))
      .value;

  late final _$fetchMenusFutureAtom =
      Atom(name: '_MenuStoreRest.fetchMenusFuture', context: context);
  ...
  late final _$menuListAtom =
      Atom(name: '_MenuStoreRest.menuList', context: context);
  ...
  late final _$successAtom =
      Atom(name: '_MenuStoreRest.success', context: context);
  ...
  late final _$getMenusAsyncAction =
      AsyncAction('_MenuStoreRest.getMenus', context: context);
